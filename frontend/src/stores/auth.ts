...
export const useAuthStore = defineStore('auth', () => {
  ...
  function useApiKey(key: string): void {
    apiKey.value = key
    token.value = ''
    subject.value = { tenantId: 't-demo', admin: true, scopes: ['admin:all'], username: 'apikey' }
    setAuth({ apiKey: key, token: '', subject: subject.value })
  }
